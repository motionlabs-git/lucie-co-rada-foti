		...
		<>
			...
			<section className='w-full rounded-lg border border-white/10 p-4'>
				...
				<p className='text-3xl'>
					...
					Quibusdam maxime excepturi consequatur est dolore labore
					quisquam vel eaque. Itaque ullam asperiores nemo est
					blanditiis porro perferendis necessitatibus saepe!
					Voluptatum, eveniet?
				</p>
			</section>
		</>
