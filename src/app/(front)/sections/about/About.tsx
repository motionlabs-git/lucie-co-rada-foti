...
const aboutLucka = 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Rem eligendi et, possimus laborum esse iste accusamus! Suscipit magni similique, reprehenderit error dolore quasi quia quaerat neque quam ab recusandae incidunt.'
...
const About = () => {
    ...
    return (
        ...
        <div id='about' className='h-[300vh] w-full'>
            ...
            <div id='aboutPart1' className='flex flex-col items-center justify-center sticky top-0 h-screen'>
                ...
                <p className='mt-6 text-center max-w-6xl'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eligendi a ipsam dolorum voluptate praesentium exercitationem velit voluptates, voluptatum ex sunt quam nobis dolorem! Quasi quisquam eveniet velit accusamus magni. Molestias?</p>
            </div>
