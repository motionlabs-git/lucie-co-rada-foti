            ...
            <nav
                ...
                <div className=' relative w-full h-full p-2 flex gap-2 items-center border-black/20 border-[1px] rounded-lg'>
                    ...
                    <div id='navLinks' className='relative w-0 overflow-hidden flex gap-4 items-center justify-center'>
                        <button onClick={() => scrollTo('gallery')} className='navLink opacity-0 text-black font-satoshiBold border border-black/20 rounded-xl px-4 py-3 hover:border-black duration-300 whitespace-nowrap'>Galerie</button>
                        <button onClick={() => scrollTo('gallery')} className='navLink opacity-0 text-black font-satoshiBold border border-black/20 rounded-xl px-4 py-3 hover:border-black duration-300 whitespace-nowrap'>Ceník</button>
                        <button onClick={() => scrollTo('gallery')} className='navLink opacity-0 text-black font-satoshiBold border border-black/20 rounded-xl px-4 py-3 hover:border-black duration-300 whitespace-nowrap'>O mně</button>
                    </div>
