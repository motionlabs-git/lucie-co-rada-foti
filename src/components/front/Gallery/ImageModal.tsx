...
const ImageModal = ({ img, title, nextImage, prevImage, handleCloseImage }: { img: string, title: string, nextImage: () => void, prevImage: () => void, handleCloseImage: () => void }) => {
    return (
        <div id='imageModal' className='select-none fixed z-50 w-screen h-screen top-0 left-0 px-10 py-10 flex justify-center items-center bg-black/50 backdrop-blur-md'>
            ...
            <button onClick={handleCloseImage} className='absolute top-10 right-10 text-white font-6xl'><CrossIcon size={34} className='duration-300 text-white hover:text-orange hover:scale-95'></CrossIcon></button>
