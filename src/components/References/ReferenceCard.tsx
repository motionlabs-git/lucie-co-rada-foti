    ...
    return (
        ...
        >
            ...
            <div className='relative'>
                <h3 className='font-bellefair text-orange text-2xl text-center opacity-0 group-hover:opacity-100 duration-300 group-hover:delay-200'>{title}</h3>
                <p className='text-white font-bellefair opacity-0 group-hover:opacity-100 duration-300 group-hover:delay-400'>{description}</p>
            </div>
        </div>
    )
}
