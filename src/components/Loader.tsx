    ...
    if (isActive)
        return (
            <section id="loader" className='fixed top-0 left-0 w-full h-screen bg-bone z-50 flex items-center justify-center'>
                <h1 className='absolute top-4 left-4 text-2xl leading-0'><strong className='text-2xl'>Načítání...</strong></h1>

                <h1 className='flex gap-4 items-baseline'><em className=''>Připravit</em><em className=''>Úsměr</em><em className=''>Sýr!</em></h1>
